...
final class Version20260922122506 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE status_history (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, old_status VARCHAR(255) NOT NULL, new_status VARCHAR(255) NOT NULL, changed_at DATETIME NOT NULL, lead_id INTEGER NOT NULL, CONSTRAINT FK_2F6A07CE55458D FOREIGN KEY (lead_id) REFERENCES lead (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
